#pragma checksum "E:\gensec\Documents\GitHub\networkApp\networkApp\Views\TestConstructor\Create.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "9f8b00e938e4e7d0a8cf9327defb5242250a9971"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"9f8b00e938e4e7d0a8cf9327defb5242250a9971", @"/Views/TestConstructor/Create.cshtml")]
...
#nullable disable
            WriteLiteral(" \r\n    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "9f8b00e938e4e7d0a8cf9327defb5242250a99714493", async() => {
                WriteLiteral(@"
        ...
        <script>
            ...
            function createAnswer(num) {
                ...
                numAnswer++;
                console.log()
                let str = '\<div id=""ans' + numAnswer + '"" style=""display:inline;"" num=""' + numAnswer + '""><input id=""ka' + numAnswer + '""  v");
                WriteLiteral(@"alue=""' + numAnswer + '"" type=""' + getType(num) + '"" name=""isTrue[' + num + ']""/>\
            ...
            function deleteAnswer(num) {
                document.getElemen");
                WriteLiteral(@"tById(""sbtn"").style.visibility = ""hidden"";
            ...
            function validate() {
                ...
                let ");
                WriteLiteral(@"counterContainer = document.getElementById(""baseContainer"").children.length;
                ...
                for (var i = 1; i < counterContainer; i++) {
                    ...
                    let counterBox = 0;
                    for (v");
                WriteLiteral(@"ar j = 1; j < counterAnswers; j++) {
                ...
                if (counterChild > 0) {
    ");
                WriteLiteral(@"                for (var i = 0; i < counterChild; i++) {
           ...
           ");
                WriteLiteral(@"             let childComp = document.getElementById(""listErrors"");
                        let div = document.createElement('div');
