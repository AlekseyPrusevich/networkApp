#pragma checksum "C:\Users\GENSEC-Notebook\Documents\GitHub\networkApp\networkApp\Views\TestConstructor\Create.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a17cba95dd0128fbb9bfd6dd8c25c59d4e6308e4"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a17cba95dd0128fbb9bfd6dd8c25c59d4e6308e4", @"/Views/TestConstructor/Create.cshtml")]
...
#nullable disable
            WriteLiteral(" \r\n    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "a17cba95dd0128fbb9bfd6dd8c25c59d4e6308e44583", async() => {
                WriteLiteral(@"
        ...
        <script>
            ...
            function createQuestion() {
                ...
                let str = '\<div id=""q' + numQuestion + '""><input type=""text"" name=""nameQuestion"" placeholder=""Введите вопрос""/>\
                    ...
                    <button onclick=""createAnswer('+ numQuestion + ')"">Добавить отв");
                WriteLiteral(@"ет</button>\
            ...
            function createAnswer(num) {
                ...
                let childComp = document.getElementById(""q"" + ");
                WriteLiteral(@"num);
                let div = document.createElement('div');
                div.innerHTML = str;
                childComp.appendChild(div);
            ...
            function apply()
            {
                for (var i = 1; i <= numAnswer; i++) { 
                    i");
                WriteLiteral(@"f (deletable.indexOf(i) >= 0) {
                        continue;
                    }
                    else {
